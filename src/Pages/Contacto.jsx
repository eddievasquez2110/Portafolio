                    ...
                    <div className="mt-8 overflow-hidden">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <form className="p-6 flex flex-col justify-center">
                                ...
                                <Link to={'https://web.whatsapp.com/sen?phone=+51925271546'} target='_blank' className="md:w-32 bg-indigo-600 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-10 hover:bg-indigo-500 transition ease-in-out duration-300" >
                                    Contactar
                                </Link>
                            </form>
                        </div>
